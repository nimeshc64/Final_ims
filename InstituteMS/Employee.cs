...
namespace InstituteMS
{
    public partial class Employee : Form
    {
        ...
        private void empContacttxt_TextChanged(object sender, EventArgs e)
        {
        ...
        private void payEmpAmounttxt_KeyPress(object sender, KeyPressEventArgs e)
        {
            v.NumTextBox(e);
        }

        private void payEmpYeartxt_KeyPress(object sender, KeyPressEventArgs e)
        {
            v.NumTextBox(e);
        }
