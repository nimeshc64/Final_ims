...
namespace InstituteMS
{
    public partial class Teacher : Form
    {
        ...
        private void teaContacttxt_KeyPress(object sender, KeyPressEventArgs e)
        {
            v.NumTextBox(e);
        }

        private void teaNICtxt_KeyPress(object sender, KeyPressEventArgs e)
        {
            
        }

        private void teaIDtxt_KeyPress(object sender, KeyPressEventArgs e)
        {
            v.NumTextBox(e);
        }
